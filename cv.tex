...
\input{papers}
\newcommand\formal[1]{}
% cp ~/ed/cv.pdf ~/LSA-Files/Public/html
\newcommand\volume{}
\newcommand\separator{:}
...
\item Asfaw, K., Park, J., Ho, A., King, A. A., and Ionides, E. L. (2021). Partially observed Markov processes with spatial structure via the R package spatPomp. {\it arxiv:2101.01157v2}.
  
\item  King, A. A., Lin, Q., and Ionides, E. L. (2021). Markov genealogy processes. {\it arxiv:2105.12730}.


\item  King, A. A., Lin, Q., and Ionides, E. L. (2020). The sampled Moran genealogy process. {\it arxiv:2002.11184}.


  %{\it medRxiv:2020.05.02.20074104}
% \url{https://doi.org/10.1101/2020.05.02.20074104}
  
%Kraay, A. N. M., Ionides, E. L., Lee, G. O., Cevallos, W. and Eisenberg, J. N. (2018). Direct, indirect, and overall effectiveness of Rotarix vaccination in rural Ecuador, 2008-2013. In review.

%\item Tapia Granados, J. A. and Ionides, E. L. (2012). Are income and health cointegrated? Life expectancy, mortality, and economic growth in Australia, 1920-2000. 

%\item Tapia Granados, J. A.,  and Ionides, E. L. (2016). Population health in expansion and recession: Europe since 2000. Revised for {\em Health Economics}.
...
\item  Ionides, E. L., Asfaw, K., Park, J., and King, A. A. (2021). Bagged filters for partially observed spatiotemporal systems. {\em Journal of the American Statistical Association, prepublished online}. 
...
\item Kraay, A. N. M., Ionides, E. L., Lee, G. O., Cevallos Trujillo, W. F., and Eisenberg, J. N. S. (2020). Effect of childhood rotavirus vaccination on community rotavirus prevalence in rural Ecuador, 2008-2013. {\em International Journal of Epidemiology}, pre-published online.
...
%\lsp
%\begin{mylist}{MANUSCRIPTS SUBMITTED FOR PUBLICATION}

%\item {\footnotesize Note: on all papers I am either the only statistician or the senior statistician. Students and postdocs are underlined.}
...
%\item Park, J., and Ionides, E. L. (2019). A guided intermediate resampling particle filter for inference on high dimensional systems. {\em arxiv:1708.08543v2}.
...
%\item{\bf 2009-present} Editorial board for Journal of Informatics and Mathematical Sciences.

\item{\bf 2007-2009} Associate editor for Annals of Statistics.

%\item{\bf 2004-present} Editorial board for International Journal of Statistics and Systems.
...
%\begin{mylist}{GRANT REFEREE SERVICE} %rrrrrrrrrrrrrrrrrrrrrrrrrrr
...
%\item{\bf 2016}. Organizer for a session on ``Networks in Disease Transmission Dynamics'' at the Isaac Newton Institute workshop on Theoretical Foundations for Statistical Network Analysis.
...
%\item{Caleb Ki.}  (Current). Jointly supervised with Jonathan Terhorst.
...
%Now a postdoc at Boston University.
...
%Now Associate Professor of Statistics at Purdue.

\item{Carles Bret\'{o}.} {\it Statistical inference for nonlinear dynamical systems} (2007). 
%Now Assistant Professor of Economics at University of Valencia, Spain.
