...
\item  King, A. A., Lin, Q., and Ionides, E. L. (2026).  Exact phylodynamic likelihood via structured Markov genealogy processes.  {\it arxiv:2405.17032}.

\item Lee, J. W., Szegda, W,, Song, Z. and Ionides, E. L. (2026). Jagged AI in Scientific Peer Review: Evidence from POMP Data Analysis {\it arXiv:2605.07855}.

\item Yang, B., Wheeler, J., Duffy, M. A., King, A. A. and Ionides, E. L. (2025). Mechanistic models for panel data: Analysis of ecological experiments with four interacting species. {\it arXiv:2506.04508}.
    
\item Tapia Granados, J. A. and Ionides, E. L. (2025).
  Income, health, and cointegration. {\it arxiv:2407.15755}.

\item Tan, K., Hooker, G. and Ionides, E. L. (2024). Accelerated inference for partially observed Markov processes using automatic differentiation. {\it arxiv:2407.03085}.
...
\item Wheeler, J. and Ionides, E. L. (2025). Revisiting inference for ARMA models: Improved fits and superior confidence intervals. {\it PLoS One} {\volume 20}{\separator}e0333993.

\item Breto, C., Wheeler, J., King, A. A. and Ionides, E. L. (2025). panelPomp: Analysis of Panel Data via Partially Observed Markov Processes in R. {\it The R Journal}, {\volume 27}{\separator}180-199.

\item Van Wyk, H.,  Brouwer, A. F.,  Lee, G. O., Marquez, S., Andrade, P.,  Ionides, E. L., Coloma, J., and Eisenberg, J. N. S. (2025). Early detection of dengue outbreaks: Transmission model analysis of a dengue outbreak in a remote setting in Ecuador. {\it Epidemiology} {\volume 36}{\separator}636--645.
...
\item Ionides, E. L., Ning, N. and Wheeler, J. (2024). An iterated block particle filter for inference on coupled dynamic systems with shared and unit-specific parameters. {\it Statistica Sinica} {\volume 34}{\separator}1145--1166.
...
%% NSF-DMS-2526827/2526828
%% Dates: initial award notification
\grantAmount{\\Total award: \$400,000.}
...
\item{\bf 2022-2026 } Associate Chair for Undergraduate Studies
\item{\bf 2014-2015, 2016-2026 } Undergraduate curriculum committee, chair
\item{\bf 2013-2015, 2022-2026 } Department executive committee
\item{\bf 2024-2026 } Faculty award nomination committee
...
\item{\bf 2024-26 } Natural Sciences Divisional Evaluation Committee for tenure and promotion cases.
...
Topics in Applied Statistics: Phylodynamic Inference (STATS 700).
...
\begin{tabbing}
Kevin Bakker \hspace{2.5cm} \= 2017 \hspace{1cm} \= Ecology \& Evolutionary Biology\\
Christoph Boehm \>  2016  \> Finance\\
Peter Boldenow \>2012 \> Epidemiology\\
Clinton Carlson \>2014 \> Civil \& Envoronmental Engineering\\
Sunrit Chakraborty \>2025 \> Statistics\\
Prayag Chatha \>2025 \> Statistics\\
Holly Chung \>2013 \> Mathematics\\
Stephanie Colon-Rodriguez \>current \> Climate \& Space Sciences\\
...
Declan McNamara \> 2025 \> Statistics\\
...
\begin{tabbing}
  ...
  Seong-Hwan Jun \> 2017 \> Statistics \> University of British Columbia, Canada\\
Jonas Str\"{o}jby \> 2010 \> Mathematical Statistics \> Lund University, Sweden\\
Mohan Wu \> 2025 \> Statistics \> University of Waterloo, Canada\\
\end{tabbing}
...
\begin{reflist}{MASTERS RESEARCH SUPERVISION}
  \item Anjali Arora, Santosh Desai, Ching Yun (Winnie) Hsu, Urvi Mehta. The statistical efficiency of deep learning relative to maximum likelihood for phylodynamic inference (2026). Co-supervised with Aaron King.
\item  Zhisheng Song. Jagged AI in Scientific Peer Review: Evidence from POMP Data Analysis (2026).
\item{Ziheng Wei}. SDE-POMP modeling for ecosystem analysis: Modeling predator–prey relationships in rotifer chemostats (2025).
...
\item{Oliver Finamore}. The statistical efficiency of deep learning relative to maximum likelihood for phylodynamic inference. Research project, co-supervised with Aaron King (2026).
\item{Shuge Ouyang}. Improving Implicit Spatiotemporal Inference by Combining Particle Filters and Neural Posterior Estimation. Honors thesis (2026).
\item{Sijia Wang}. A Nitrogen-Scaled POMP Model for Intraguild Predation Dynamics. Honors thesis (2026).
\item{Jin Wook Lee and William Szegda}. Jagged AI in Scientific Peer Review: Evidence from POMP Data Analysis. Research project (2026).
...
\item{Jun Chen}. Developing Pypomp: A Python package for inference on partially obseerved Markov processes. Research project (2025).
...
\item{\bf 2025 } University of Waterloo, Statistics \& Actuarial Sciences department seminar.
